        ...
        <div className="-m-8 flex flex-wrap items-center justify-between">
          <div className="w-auto p-8">
            <div className="inline-flex items-center">
              <img
                ...
                height={50}
              />
              <span className="ml-4 text-lg lg:text-xl font-bold text-sky-950">
          ...
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center">
              <li className="p-5">
                <a
                  className="font-bold text-lg hover:text-gray-700"
                  href="mailto:kapolglobalacademy@gmail.com"
                >
                  kapolglobalacademy@gmail.com
                </a>
              </li>
              <li className="p-5">
                <a
                  className="font-bold text-lg hover:text-gray-700"
                  href="tel:+919137995464"
                >
                  9137995464
                </a>
